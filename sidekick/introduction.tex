...
One key technical challenge with this approach is how the proxy in a Sidekick
protocol can
...
nearest AWS datacenter, the Sidekick PEP was able to trigger early retransmissions
...
(\Cref{fig:sidekick:real-world}). The Sidekick PEP was also able to improve the
...
The rest of this chapter discusses three motivating scenarios for Sidekick
protocols
