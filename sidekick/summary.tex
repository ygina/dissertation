...
and wire format of Sidekick messages described in \Cref{sec:sidekick:init},
...
and both are better than end-to-end CUBIC in \Cref{fig:sidekick:fairness-line}), but not
...
more in \Cref{sec:sidekick:appendix}.
