...
built around quACKs (\Cref{sec:sidekick:init,sec:sidekick:sender}),
discusses three motivating scenarios (\Cref{sec:sidekick:motivating}) and
...
(\Cref{sec:sidekick:real-world,sec:sidekick:emulation}).
