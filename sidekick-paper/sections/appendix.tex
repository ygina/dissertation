...
% python time_vs_cwnd.py --name retx --loss 0 1 --max-x 20 --max-y 130 --legend 0 --http quic
% mv graphs/cwnd_retx_60s_delay0_loss0p.pdf graphs/cwnd/cwnd_cubic_loss0p.pdf
% mv graphs/cwnd_retx_60s_delay0_loss1p.pdf graphs/cwnd/cwnd_cubic_loss1p.pdf
% python time_vs_cwnd.py --name retx --loss 0 1 --max-x 20 --max-y 130 --legend 0 --http quack
% mv graphs/cwnd_retx_60s_delay0_loss0p.pdf graphs/cwnd/cwnd_pacubic_loss0p.pdf
% mv graphs/cwnd_retx_60s_delay0_loss1p.pdf graphs/cwnd/cwnd_pacubic_loss1p.pdf
% python time_vs_cwnd.py --name retx --loss 0 1 --max-x 20 --max-y 130 --legend 0 --http pep_h2 pep_r1
% mv graphs/cwnd_retx_60s_delay0_loss0p.pdf graphs/cwnd/cwnd_split_loss0p.pdf
% mv graphs/cwnd_retx_60s_delay0_loss1p.pdf graphs/cwnd/cwnd_split_loss1p.pdf
% python time_vs_cwnd.py --name retx --loss 0 1 --max-x 20 --max-y 130 --legend 0
% mv graphs/cwnd_legend.pdf graphs/cwnd/
% scp -r mn:/home/gina/sidecar/plot/graphs/cwnd/ figures

\begin{figure*}[h]
\centering
\includegraphics[width=0.8\linewidth]{figures/cwnd/cwnd_legend.pdf}\\
\begin{subfigure}{0.32\linewidth}
	\includegraphics[width=\linewidth]{figures/cwnd/cwnd_split_loss0p.pdf}
	\caption{Split CUBIC, 0\% loss.}
	\label{fig:time-cwnd:split-loss0p}
\end{subfigure}
\begin{subfigure}{0.32\linewidth}
	\includegraphics[width=\linewidth]{figures/cwnd/cwnd_pacubic_loss0p.pdf}
	\caption{PACUBIC, 0\% loss.}
	\label{fig:time-cwnd:pacubic-loss0p}
\end{subfigure}
\begin{subfigure}{0.32\linewidth}
	\includegraphics[width=\linewidth]{figures/cwnd/cwnd_cubic_loss0p.pdf}
	\caption{CUBIC, 0\% loss.}
	\label{fig:time-cwnd:cubic-loss0p}
\end{subfigure}
\begin{subfigure}{0.32\linewidth}
	\includegraphics[width=\linewidth]{figures/cwnd/cwnd_split_loss1p.pdf}
	\caption{Split CUBIC, 1\% loss.}
	\label{fig:time-cwnd:split-loss1p}
\end{subfigure}
\begin{subfigure}{0.32\linewidth}
	\includegraphics[width=\linewidth]{figures/cwnd/cwnd_pacubic_loss1p.pdf}
	\caption{PACUBIC, 1\% loss.}
	\label{fig:time-cwnd:pacubic-loss1p}
\end{subfigure}
\begin{subfigure}{0.32\linewidth}
	\includegraphics[width=\linewidth]{figures/cwnd/cwnd_cubic_loss1p.pdf}
...
(\Cref{sec:design:cubic}), including how they were derived and why the PACUBIC
