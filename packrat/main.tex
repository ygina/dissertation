...
Packrat protocol (\Cref{fig:packrat:payloads}), starting with the handshake.
...
each packet as described in \Cref{sec:packrat:design:proxy}. We use
...
\begin{enumerate}[noitemsep]
    ...
    \item How do the rateless and sparse optimizations in
     \Cref{sec:packrat:design:client} impact the link overheads of the Packrat
     protocol?
...
when the data receiver is near a lossy path segment (\Cref{fig:packrat:perf}).
