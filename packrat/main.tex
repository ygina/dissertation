...
consider hints from the application for rateless and sparse quACKing
...
\begin{enumerate}[noitemsep]
    ...
    \item How do the rateless and sparse optimizations in \Cref
...
since the client sparsely quACKs (\Cref{fig:memory:media}). The
