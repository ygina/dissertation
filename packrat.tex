...
\begin{itemize}[noitemsep]
    ...
    \item Optimizations to improve proxy
     ...
     (\Cref{sec:packrat:protocol:receiver-behavior}).
    ...
    \item An emulation study of the performance enhancements, as well as the CPU,
     memory, and link overheads of using the Packrat protocol (\Cref{sec:packrat:evaluation}).
\end{itemize}
...
(\Cref{sec:quack:rateless,sec:packrat:protocol:receiver-behavior}). We also
...
each packet as described in \Cref{sec:packrat:protocol:proxy-behavior}. We use
...
optimistic eviction in \Cref{sec:packrat:evaluation:memory-overheads}.
