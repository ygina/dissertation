...
When speaking the Sidekick protocol, a proxy needs to be
able to refer to and efficiently
...
The main consideration when selecting the number of bytes, $b$, in an
...
in terms of communication an computation costs. The
...
times (\Cref{tab:quack:overview:practical}).
...
\input{quack/tables/overview.tex}
