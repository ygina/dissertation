...
\input{splitting-paper/figures_tex/bbr-over-time.tex}
...
\input{splitting-paper/tables/parameters.tex}
...
\input{splitting-paper/figures_tex/mininet.tex}
\input{splitting-paper/tables/cca-implementations.tex}
...
\input{splitting-paper/figures_tex/2d-heatmap.tex}
...
behavior of each CCA implementation are available in \Cref{sec:appendix:heatmaps}.
...
\input{splitting-paper/tables/network-path-analysis.tex}
...
\input{splitting-paper/figures_tex/quic.tex}
...
\input{splitting-paper/figures_tex/quic-predictions.tex}
...
\input{splitting-paper/figures_tex/accuracy-split.tex}
