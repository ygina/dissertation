\begin{figure*}[t!]
    ...
    \begin{subfigure}[b]{0.22\linewidth}
        ...
        \includegraphics[width=\linewidth,trim={0 0 2cm 0.7cm},clip]
         {figures/heatmaps/heatmap_tcp_cubic_10mbps.pdf}
    ...
    \begin{subfigure}[b]{0.22\linewidth}
        \centering
        \includegraphics[width=\linewidth,trim={0 0 2cm 0.7cm},clip]
         {figures/heatmaps/heatmap_tcp_bbr1_10mbps.pdf}
        \captionsetup{skip=4pt}
        \caption{TCP BBRv1.}
    ...
    \begin{subfigure}[b]{0.22\linewidth}
        \centering
        \includegraphics[width=\linewidth,trim={0 0 2cm 0.7cm},clip]
         {figures/heatmaps/heatmap_tcp_bbr2_10mbps.pdf}
        \captionsetup{skip=4pt}
        \caption{TCP BBRv2.}
    ...
    \begin{subfigure}[b]{0.22\linewidth}
        \centering
        \includegraphics[width=\linewidth,trim={0 0 2cm 0.7cm},clip]
         {figures/heatmaps/heatmap_tcp_bbr3_10mbps.pdf}
        \captionsetup{skip=4pt}
        \caption{TCP BBRv3.}
    ...
    %     \centering
    %     \includegraphics[width=\linewidth,trim={0 0 2cm 0.7cm},clip]
    %      {figures/heatmaps/heatmap_tcp_cubic_50mbps.pdf}
    %     \captionsetup{skip=4pt}
    %     \caption{TCP CUBIC, 50 Mbit/s.}
    %     \label{fig:2d-heatmap:cubic-50}
    % \end{subfigure}
    % \begin{subfigure}[b]{0.22\linewidth}
    %     \centering
    %     \includegraphics[width=\linewidth,trim={0 0 2cm 0.7cm},clip]
    %      {figures/heatmaps/heatmap_tcp_bbr1_50mbps.pdf}
    %     \captionsetup{skip=4pt}
    %     \caption{TCP BBRv1, 50 Mbit/s.}
    %     \label{fig:2d-heatmap:bbr1-50}
    % \end{subfigure}
    % \begin{subfigure}[b]{0.22\linewidth}
    %     \centering
    %     \includegraphics[width=\linewidth,trim={0 0 2cm 0.7cm},clip]
    %      {figures/heatmaps/heatmap_tcp_bbr2_50mbps.pdf}
    %     \captionsetup{skip=4pt}
    %     \caption{TCP BBRv2, 50 Mbit/s.}
    %     \label{fig:2d-heatmap:bbr2-50}
    % \end{subfigure}
    % \begin{subfigure}[b]{0.22\linewidth}
    %     \centering
    %     \includegraphics[width=\linewidth,trim={0 0 2cm 0.7cm},clip]
    %      {figures/heatmaps/heatmap_tcp_bbr3_50mbps.pdf}
    %     \captionsetup{skip=4pt}
    %     \caption{TCP BBRv3, 50 Mbit/s.}
    %     \label{fig:2d-heatmap:bbr3-50}
    % \end{subfigure}
    % \begin{subfigure}[b]{1cm}
    %     \includegraphics[width=1cm,trim={8cm 0 0 0},clip]
    %      {figures/heatmaps/heatmap_tcp_bbr3_50mbps.pdf}
