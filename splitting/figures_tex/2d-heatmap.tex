\begin{figure*}[t!]
    ...
    \begin{subfigure}[b]{0.22\linewidth}
        ...
        \caption{TCP CUBIC.}
        \label{fig:splitting:2d-heatmap:cubic-10}
    \end{subfigure}
    \begin{subfigure}[b]{0.22\linewidth}
        \centering
        \includegraphics[width=\linewidth,trim={0 0 2cm 0.7cm},clip]
        ...
        \captionsetup{skip=4pt}
        \caption{TCP BBRv1.}
        \label{fig:splitting:2d-heatmap:bbr1-10}
    \end{subfigure}
    \begin{subfigure}[b]{0.22\linewidth}
        \centering
        \includegraphics[width=\linewidth,trim={0 0 2cm 0.7cm},clip]
         {splitting/figures/heatmaps/heatmap_tcp_bbr2_10mbps.pdf}
        \captionsetup{skip=4pt}
        \caption{TCP BBRv2.}
        \label{fig:splitting:2d-heatmap:bbr2-10}
    \end{subfigure}
    \begin{subfigure}[b]{0.22\linewidth}
        \centering
        \includegraphics[width=\linewidth,trim={0 0 2cm 0.7cm},clip]
        ...
        \captionsetup{skip=4pt}
        \caption{TCP BBRv3.}
        \label{fig:splitting:2d-heatmap:bbr3-10}
    \end{subfigure}
    ...
    \caption{The link rate utilization calculated as the ratio of achieved
     ...
     the link rate increases (\Cref{sec:splitting:appendix}). Median of $n=20$ trials.}
    \label{fig:splitting:2d-heatmap}
\end{figure*}
